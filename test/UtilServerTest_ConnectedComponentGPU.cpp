...
#include "../algo/ConnectedComponent/ConnectedComponentGPU.h"
...
int main(int argc, char *argv[])
{
    if(argc != 4 && argc != 5)
    {
        std::cout << "Usage:" << std::endl << "./UtilServerTest_ConnectedComponentGPU vCount eCount numOfInitV [nodeNo]" << std::endl;
        return 1;
    }
    ...
    auto testUtilServer = UtilServer<ConnectedComponentGPU<int, int>, int, int>(vCount, eCount, numOfInitV, nodeNo);
