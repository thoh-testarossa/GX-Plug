...
int main(int argc, char *argv[])
{
    if(argc != 5 && argc != 6)
    {
        ...
        << "./UtilServerTest_ConnectedComponentGPU vCount eCount numOfInitV maxComputeUnits [nodeNo]" << std::endl;
        return 1;
    }
    ...
    auto testUtilServer = UtilServer<ConnectedComponentGPU<int, int>, int, int>
