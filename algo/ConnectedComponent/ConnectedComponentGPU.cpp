...
template <typename VertexValueType, typename MessageValueType>
void ConnectedComponentGPU<VertexValueType, MessageValueType>::Init(int vCount, int eCount,int numOfInitV, int maxComputeUnits)
{
...
template<typename VertexValueType, typename MessageValueType>
int ConnectedComponentGPU<VertexValueType, MessageValueType>::MSGApply_array(int computeUnitCount, ComputeUnit<VertexValueType> *computeUnits, MessageValueType *mValues)
{

}
template<typename VertexValueType, typename MessageValueType>
int ConnectedComponentGPU<VertexValueType, MessageValueType>::MSGGenMerge_array(int computeUnitCount, ComputeUnit<VertexValueType> *computeUnits, MessageValueType *mValues)
{
