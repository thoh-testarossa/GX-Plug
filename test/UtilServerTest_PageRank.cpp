...
int main(int argc, char *argv[])
{
    if (argc != 5 && argc != 6)
    {
        ...
        << "./UtilServerTest_PageRank vCount eCount numOfInitV maxComputeUnits [nodeNo]"
                  << std::endl;
        return 1;
    }
    ...
    auto testUtilServer = UtilServer<PageRank<std::pair<double, double>, PRA_MSG>, std::pair<double, double>, PRA_MSG>
