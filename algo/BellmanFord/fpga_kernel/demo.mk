...
include $(ABS_COMMON_REPO)/utils/xcl2/xcl2.mk
...
EXECUTABLE = host
CMD_ARGS = $(BUILD_DIR)/gs_top.xclbin
EMCONFIG_DIR = $(TEMP_DIR)
EMU_DIR = $(SDCARD)/data/emulation

BINARY_CONTAINERS += $(BUILD_DIR)/gs_top.xclbin
BINARY_CONTAINER_OBJS += $(TEMP_DIR)/gs_top.xo
...
# Building kernel
$(TEMP_DIR)/gs_top.xo: ./gs_top.cpp
	mkdir -p $(TEMP_DIR)
	$(VPP) $(CLFLAGS) --temp_dir $(TEMP_DIR) -c -k gs_top -I'$(<D)' -o'$@' '$<'
$(BUILD_DIR)/gs_top.xclbin: $(BINARY_CONTAINER_OBJS)
	mkdir -p $(BUILD_DIR)
...
ifeq ($(HOST_ARCH), x86)
	...
	XCL_EMULATION_MODE=$(TARGET) ./$(EXECUTABLE) $(BUILD_DIR)/gs_top.xclbin
else
	mkdir -p $(EMU_DIR)
...
ifeq ($(HOST_ARCH), x86)
	./$(EXECUTABLE) $(BUILD_DIR)/gs_top.xclbin
endif
endif
